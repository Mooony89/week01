#D2-Tutorial2-db_CRUD_operations.py
...
def write_dataframe_to_table(df, table_name, connection_params):
    ...
    """
    engine = create_engine(f"postgresql://{connection_params['postgres']}:{connection_params['omlogin66']}@{connection_params['localhost']}:{connection_params['5432']}/{connection_params['telecom']}")
